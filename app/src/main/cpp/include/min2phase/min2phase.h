...
namespace min2phase{
    ...
    public:
        ...
        virtual void onProgress(int64_t nodesSearched, int8_t currentDepth) = 0;
        virtual void onNewSolutionFound(const std::string& solution, int8_t steps) = 0;
    ...
    std::string solve(const std::string& facelets, int8_t maxDepth, int32_t probeMax, int32_t probeMin,
                      int8_t verbose, uint8_t* usedMoves = nullptr, SearchCallback* callback = nullptr);
